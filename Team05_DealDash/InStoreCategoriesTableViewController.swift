...
//InStoreCategoriesTableViewController class dis[plays all the categories available
class InStoreCategoriesTableViewController: UITableViewController {
    ...
    //prepareForSegue function directs to InStoreOffersTableViewController when clicks on a category
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        let offersTVC:InStoreOffersTableViewController = segue.destinationViewController as! InStoreOffersTableViewController
